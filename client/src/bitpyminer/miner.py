...
class Miner:
    ...
    def mine(self,output_div,height,version,prev_block,bits,transactions=[],time_offset=0)->bool:
        """mine.
        ...
        block_header = BlockHeader(version,prev_block,bits,[coinbase_tx]+transactions,time_offset = time_offset)
